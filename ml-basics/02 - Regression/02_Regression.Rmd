...
> We'll require some packages to knock-off this module. You can have them installed as:
 `install.packages(c('tidyverse', 'tidymodels', 'glmnet', 'randomForest', 'xgboost', 'patchwork', 'paletteer', 'statip', 'here', 'summarytools'))`
...
pacman::p_load('tidyverse', 'tidymodels', 'glmnet',
               ...
               'paletteer', 'statip', 'here', 'devtools',
               'doParallel', 'summarytools')
```
