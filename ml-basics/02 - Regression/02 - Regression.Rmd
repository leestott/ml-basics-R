...
install.packages(c('knitr','rmarkdown', 'tidyverse', 'tidymodels', 'glmnet', 'plotly', 'conflicted', 'randomForest', 'xgboost', 'patchwork', 'paletteer', 'statip', 'summarytools', 'kableExtra', 'here'))
```
...
## Need to look at how you can render image inline
```{r, echo = TRUE, out.width="30%"}
knitr::include_graphics(images/encouRage.jpg)
```
